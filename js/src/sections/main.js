...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const sections = document.querySelectorAll(
    'main#main > div:not(.default-block.container-fluid):not(.subpage-hero):not(.map):not(.services):not(.specialist):not(.faq):not(.text-with-image):not(.section-title):not(.theme-form)',
  );

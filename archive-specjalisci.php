...
$is_specialist_query = is_post_type_archive('specjalisci') || get_query_var('post_type') === 'specjalisci';
  ...
  <div class="specialists">
    <div class="container">
      <div class="specialists__wrapper">
        ...
        <div class="specialists__filtration">
          <?php echo do_shortcode('[searchandfilter id="4814"]'); ?>
        </div>
        <?php endif; ?>
